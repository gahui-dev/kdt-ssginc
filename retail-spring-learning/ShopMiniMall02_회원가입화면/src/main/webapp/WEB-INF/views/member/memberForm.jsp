...
<form action="MemberAddServlet" method="post">
	*아이디:<input type="text" name="userid" id="userid">
	...
	<span id="result"></span><br> *비밀번호:<input type="text"
		name="passwd" id="passwd"><br> 비밀번호확인:<input type="text"
		name="passwd2" id="passwd2"><span id="idcheck"></span><br>
	...
	전화번호: <select name="phone1">
		...
		name="phone3"><br> 이메일: <input type="text" name="email1">@<input
		type="text" name="email2" placeholder="직접입력"> <select>
